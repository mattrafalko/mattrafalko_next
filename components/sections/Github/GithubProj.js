const GithubProj = ({ project }) => {
  return (
    <div>
      <div className='mb-4 px-2 py-3 flex flex-col border-2 border-solid border-gray-300 dark:border-indigo-900 rounded shadow hover:shadow-md transition ease-in'>
